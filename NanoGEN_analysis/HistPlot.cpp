...
void plotHistogramZ()
{
    TH1F* h1 = new TH1F("h1", "cosThetaZ*", 1000, -1.0, 1.0);

    TFile* input = new TFile("test.root", "read");
    TTree* tree = (TTree*)input->Get("GENoutput");
...
void plotHistogramX()
{
    TH1F* h1 = new TH1F("h1", "cosThetaX*", 1000, -1.0, 1.0);
...
void plotHistogramY()
{
    TH1F* h1 = new TH1F("h1", "cosThetaY*", 1000, -1.0, 1.0);
