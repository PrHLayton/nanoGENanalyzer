...
void plotHistogramZ()
{
    ...
    TFile* input_SM = new TFile("SM_old.root", "read");
    ...
    canvasZ->SaveAs("ZW_ctwi_pm2_cosThetaZ*.pdf");
...
canvasX->SaveAs("ZW_ctwi_pm2_cosThetaX*.pdf");
...
canvasY->SaveAs("ZW_ctwi_pm2_cosThetaY*.pdf");
